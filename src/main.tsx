  ...
  return (
    <>
      ...
      <div className="fixed bottom-5 right-5 z-50 flex max-w-[calc(100vw-2rem)] flex-wrap justify-end gap-2">
        ...
        <button onClick={() => setShowRegulatory(true)} className="rounded-full border border-blue-200 bg-blue-50 px-4 py-3 text-xs font-black text-blue-800 shadow-xl shadow-slate-900/10 transition hover:-translate-y-0.5 hover:border-blue-300">Regulatory</button>
