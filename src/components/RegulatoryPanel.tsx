      ...
      <div className="mx-auto my-8 max-w-5xl rounded-[2rem] border border-slate-200 bg-white shadow-2xl">
        <div className="flex items-start justify-between border-b border-slate-200 p-6 md:p-8">
          <div>
            ...
            <p className="mt-2 max-w-3xl text-sm leading-6 text-slate-600">This layer records classification, intended use, permitted and prohibited claims, labeling requirements, and accountable review. It does not assert approval that has not been established.</p>
          </div>
        ...
        <div className="mx-6 mb-6 rounded-2xl border border-blue-200 bg-blue-50 p-5 md:mx-8 md:mb-8">
          <div className="flex gap-3"><ShieldAlert className="mt-0.5 shrink-0 text-blue-700" size={19} /><div><p className="font-black text-blue-950">Current control point: regulatory status is unresolved.</p><p className="mt-1 text-sm leading-6 text-blue-900">The concept should not be treated as market-ready until classification, intended use, claims, labeling, and accountable regulatory review are established.</p></div></div>
        </div>
