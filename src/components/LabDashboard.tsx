import { BarChart3, BookOpen, Building2, CircleAlert, ClipboardCheck, FileBox, FlaskConical, GitBranch, GraduationCap, ListChecks, MessageSquare, PackageCheck, PlayCircle, ShieldCheck, UserRoundCog, X } from "lucide-react";
